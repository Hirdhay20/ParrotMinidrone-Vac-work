...
MODULES              := rsedu_image.c flightControlSystem_data.c flightControlSystem_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rtmodel.c
...
TID01EQ              := 0
NCSTATES             := 0
BUILDARGS            :=  GENERATE_ERT_S_FUNCTION=0 INCLUDE_MDL_TERMINATE_FCN=1 COMBINE_OUTPUT_UPDATE_FCNS=0 MAT_FILE=0 MULTI_INSTANCE_CODE=0 INTEGER_CODE=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 TMW_EXTMODE_TESTING=0 OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0"
MULTITASKING         := 1
EXT_MODE             := 1
EXTMODE_TRANSPORT    := 0
...
ADDITIONAL_LDFLAGS   := 
DEFINES_CUSTOM       := 
DEFINES_OTHER        := -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
COMPILE_FLAGS_OTHER  := 
...
# additional includes
REQ_INCLUDES += ;$(WQ)C:/Users/Hirdhay.Ramnarain/MATLAB/Projects/examples/parrotMinidroneCompetition/work$(WQ);$(WQ)C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/parrot/include$(WQ);$(WQ)C:/Users/Hirdhay.Ramnarain/MATLAB/Projects/examples/parrotMinidroneCompetition/work/flightControlSystem_sldrt_ert_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/ert$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
...
sldrt_ertmain.o : $(SLDRTDIR)/src/sldrt_ertmain.c $(MAKEFILE)
