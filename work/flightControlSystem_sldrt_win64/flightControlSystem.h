...
#define flightControlSystem_rtModel    RT_MODEL_flightControlSystem_T
...
typedef struct {
  ...
  int32_T memOffset;
  int32_T i;
  uint32_T FixPtSwitch;                /* '<S249>/FixPt Switch' */
  uint32_T FixPtSwitch_j;              /* '<S516>/FixPt Switch' */
  uint32_T FixPtSwitch_m;              /* '<S435>/FixPt Switch' */
  uint16_T FixPtSwitch_jj;             /* '<S16>/FixPt Switch' */
...
typedef struct {
  ...
  int32_T sfEvent;                     /* '<S2>/red_detection' */
  int32_T sfEvent_j;                   /* '<S2>/MATLAB Function' */
  ...
  boolean_T doneDoubleBufferReInit;    /* '<S2>/red_detection' */
  boolean_T objisempty;                /* '<S2>/PARROT Image Conversion' */
  boolean_T doneDoubleBufferReInit_j;  /* '<S2>/MATLAB Function' */
  boolean_T captured_not_empty;        /* '<S2>/MATLAB Function' */
...
#define rtB                            flightControlSystem_B
#define BlockIO                        B_flightControlSystem_T
#define rtP                            flightControlSystem_P
#define Parameters                     P_flightControlSystem_T
#define rtDWork                        flightControlSystem_DW
#define D_Work                         DW_flightControlSystem_T
#define rtPrevZCSigState               flightControlSystem_PrevZCX
#define PrevZCSigStates                PrevZCX_flightControlSystem_T
 ...
 * External functions *
 *====================*/
extern flightControlSystem_rtModel *flightControlSystem(void);
