...
MODULES              := rsedu_image.c flightControlSystem_data.c flightControlSystem_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
# additional includes
REQ_INCLUDES += ;$(WQ)C:/Users/Hirdhay.Ramnarain/MATLAB/Projects/examples/parrotMinidroneCompetition/work$(WQ);$(WQ)C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/parrot/include$(WQ);$(WQ)C:/Users/Hirdhay.Ramnarain/MATLAB/Projects/examples/parrotMinidroneCompetition/work/flightControlSystem_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
