...
static DataTypeTransition rtBTransitions[] = {
  ...
  { (char_T *)(&flightControlSystem_B.ControlSystem.invertzaxisGain), 0, 0, 18 },
  ...
  { (char_T *)(&flightControlSystem_B.ControlSystem.FixPtSwitch), 7, 0, 3 },

  { (char_T *)(&flightControlSystem_B.ControlSystem.FixPtSwitch_jj), 5, 0, 1 },
  ...
  { (char_T *)(&flightControlSystem_DW.sfEvent), 6, 0, 2 },

  { (char_T *)(&flightControlSystem_DW.obj), 43, 0, 1 },

  { (char_T *)(&flightControlSystem_DW.RateTransition_ActiveBufIdx), 2, 0, 1 },

  { (char_T *)(&flightControlSystem_DW.captured[0]), 3, 0, 57600 },

  { (char_T *)(&flightControlSystem_DW.doneDoubleBufferReInit), 8, 0, 4 },
